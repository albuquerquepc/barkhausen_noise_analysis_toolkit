...
from modules.paths import r798d_data_path
...
class DataShower(QWidget):
  def __init__(self):
      ...
      self.data_file_path_input.setText(r798d_data_path.original())
      ...
      self.time_axis_path_input.setText(r798d_data_path.original())
