...
from constants_and_pathing import PATH_TO_ORIGINAL_DATA
...
class DataShower(QWidget):
  def __init__(self):
      ...
      self.data_file_path_input.setText(PATH_TO_ORIGINAL_DATA)
      ...
      self.time_axis_path_input.setText(PATH_TO_ORIGINAL_DATA)
